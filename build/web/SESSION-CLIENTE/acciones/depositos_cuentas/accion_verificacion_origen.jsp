<%-- 
    ...
    Created on : 09-12-2021, 12:00:07 AM
    Author     : PC-LITE
--%>
    ...
    switch (accion) {
        ...
        case "verificar":
            ...
            if (control.verificarCuenta(id)) {
                ...
                out.print("<script>alert(\"Cuenta con saldo verifica la cuenta destino. ! \");window.location.href='../../../MCliente.jsp?panel=depositos_cuentas/verificacion_destino';</script>");
