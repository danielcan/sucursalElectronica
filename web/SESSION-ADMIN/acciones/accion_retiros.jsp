<%-- 
    ...
    Created on : 09-15-2021, 06:45:30 PM
    Author     : PC-LITE
--%>
...
<%
    ...
    switch (accion) {
            ...
            if (control.cuentaMontoVerifica(cuent,cantidad)) {
                ...
                saldonuevoOri = obtensaldoOri - monto; 
                 ...
                 try {
                  ...
                  //  int contador = 1;
                    if (contadorOri == 1) {
                        out.print("<script>alert(\"Retiro exitoso ! \");window.location.href='../../MAdmin.jsp?panel=vistas/regi_vista_retiros';</script>"); 
                        
                  //  panel = "vistas/regi_vista_carrera";
                   
                        db.desconectar();
                    }else {
                    out.print("<script>alert(\"No fue exitoso el retiro. ! \");window.location.href='MAdmin.jsp?panel=session_inicio';</script>");
                    }
                } catch (Exception e) {
        ...
        out.print("<script>alert(\"¡¡NO existe la cuenta en la sucursal!! \");window.location.href='../../MAdmin.jsp?panel=session_inicio';</script>"); 
