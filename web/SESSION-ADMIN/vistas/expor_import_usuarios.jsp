<%-- 
    Document   : expor_import_usuarios
    Created on : 09-17-2021, 02:53:45 PM
    Author     : AdminCis
--%>
...
<div class="card">
    <div class="card-body">
        <center>
            <form action="SESSION-ADMIN/acciones/accionxml_usuarios.jsp" method="POST">
                <h1>Exportar Usuarios </h1>
                <br><br>
                <label>Exportar Usuarios a XML</label> <br>
