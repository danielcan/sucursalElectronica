<%-- 
    ...
    Created on : 09-15-2021, 01:13:41 PM
    Author     : PC-LITE
--%>
        ...
        case "verificar":
         ...
         //out.println(request.getParameter("idcuentaO"));
            ...
            if (control.cuentaMontoVerifica(cuent,cantidad)) {
                ...
                saldonuevoOri = obtensaldoOri - monto; 
                 ...
                 try {
                  ...
                  //  panel = "vistas/regi_vista_carrera";
                    ...
                    out.print("<script>alert(\"Error al ingresar el saldo ; añade el monto del deposito de la cuenta. ! \");window.location.href='../../../MCliente.jsp?panel=depositos_OCuentas/monto';</script>");
                    }
                } catch (Exception e) {
              ...
              out.print("<script>alert(\"Saldo Insuficiente; añade el monto del deposito de la cuenta. ! \");window.location.href='../../../MCliente.jsp?panel=depositos_OCuentas/monto';</script>");  
            }
            break;
