<%-- 
    ...
    Created on : 09-14-2021, 12:12:40 AM
    Author     : PC-LITE
--%>
...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="SESSION-CLIENTE/acciones/depositos_OCuentas/accion_verificacion_origen.jsp" method="POST">
