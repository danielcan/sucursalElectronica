<%-- 
    Document   : verificacion_destino
    Created on : 09-11-2021, 11:13:53 PM
    Author     : PC-LITE
--%>
...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="SESSION-CLIENTE/acciones/depositos_cuentas/accion_verificacion_destino.jsp" method="POST">
